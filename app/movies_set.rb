class MoviesSet
  ...
  def self.list_missing_movie(movies_files, qualifying_files, no_prompt = 0, delta = 30, app: self.app)
    ...
    movies_files.each do |id, movie|
      ...
      collec_title, collection = Movie.movie_get(movie[:movie].ids, 'movie_set_get', app: app)
